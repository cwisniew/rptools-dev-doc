...
:::note Reserved names
<details>
    <summary>Some names are reserved for future internal usage and you will not be able set the "Allows URI Access" flags on Lib:Tokens </summary>
	<div> 
...
<html>
<head>
	<link rel="stylesheet" href="lib://HTMLTest/macro/test/test.css?cachelib=false">
</head>
<body>
